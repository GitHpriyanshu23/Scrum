...
function Stat({ label, value }: { label: string; value: string | number }) {
  return (
    <div className="border border-zinc-200 p-5 bg-white">
      <div className="font-note-heading text-4xl leading-none mb-1">{value}</div>
  ...
  return (
    <div className="flex flex-col h-screen overflow-hidden bg-[#fafaf8]">
      <header className="flex items-center justify-between px-6 h-12 border-b border-zinc-200 flex-shrink-0 bg-[#fafaf8]">
        ...
        <Link href="/app/board" className="font-mono text-[10px] uppercase tracking-widest text-zinc-400 hover:text-black transition-colors">
          Open Board →
        </Link>
      </header>
